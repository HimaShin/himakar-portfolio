    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
            ...
            <div className="hidden md:flex space-x-8">
              {['About', 'Skills', 'Projects', 'Contact'].map((item, index) => (
                <button
                  ...
                  className="relative group text-sm font-medium tracking-wide hover:text-cyan-400 transition-colors duration-300"
                >
                  {item}
      ...
      <section ref={heroRef} className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center z-10 relative">
          ...
          >
            <motion.h1 
              className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-orange-400 bg-clip-text text-transparent"
              animate={{ 
            ...
            <motion.h2 
              className="text-2xl md:text-4xl font-light mb-4 text-purple-300"
              initial={{ opacity: 0 }}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <HolographicCard
              ...
              content="B.Tech Computer Science Engineering from Siddharth Institute of Engineering and Technology with an impressive CGPA of 8.97, demonstrating consistent academic excellence."
            ...
            <HolographicCard
              ...
              content="Expert in LangGraph, Together.ai, and agentic workflows with 95% resolution rate and 80% reduction in manual intervention across enterprise systems."
            ...
            <HolographicCard
              ...
              content="Proficient in Java, Python, JavaScript with expertise in cross-platform integration, serving 500+ users with high-performance applications."
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ProjectPortal
              ...
              description="Advanced LangGraph-based system achieving 95% resolution rate with intelligent fallback mechanisms"
              metrics={["95% Resolution Rate", "80% Manual Reduction", "Enterprise Scale"]}
              technologies={["LangGraph", "Together.ai", "Mixtral-8x7B", "Python"]}
              gradient="from-cyan-400 to-blue-600"
              delay={0.2}
            />
            ...
            <ProjectPortal
              ...
              description="YOLOv3-powered computer vision system with 30% performance improvement"
              metrics={["30% Performance Boost", "Real-time Processing", "Multi-object Detection"]}
              technologies={["YOLOv3", "OpenCV", "TensorFlow", "Python"]}
              gradient="from-purple-400 to-pink-600"
              delay={0.4}
            />
            ...
            <ProjectPortal
              ...
              description="Full-stack marketplace serving 500+ users with advanced payment integration"
              metrics={["500+ Users", "Secure Payments", "Cross-platform"]}
              technologies={["Java", "JavaScript", "HTML", "MySQL"]}
              gradient="from-orange-400 to-red-600"
              delay={0.6}
            />
            
            <ProjectPortal
              title="MotionCut Automation"
              description="Internship project delivering 70% workflow improvement and 40% error reduction"
              metrics={["70% Workflow Improvement", "40% Error Reduction", "20% Response Optimization"]}
              technologies={["Python", "Automation", "API Integration", "Testing"]}
